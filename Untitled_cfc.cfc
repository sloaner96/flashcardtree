<cfcomponent output="true">
	...
	<cfset this.name = "flashcardtree_11111">
  ...
  <cfsetting enablecfoutputonly="false" showdebugoutput="true" requesttimeout="20">
	...
	<cffunction name="onApplicationStart" access="public" returntype="boolean" output="true" hint="Start application">
		...
		<cfset application.baseURL = "http://www.celcreations.com/">
		...
		<!--- create a structure for persistent controllers --->
		<cfset application.controllers = structNew()>
		<!--- all need a nav contoller --->
		<cfset application.controllers.nav = createObject("controllers.nav")>
